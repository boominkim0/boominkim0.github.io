<template>
    <NuxtLayout name="marriage-layout">
        <MarriageSakura />
        <!-- BGM 재생 버튼 -->
        <div class="fixed top-5 right-5" style="z-index: 1">
            <UButton
                color="gray"
                variant="solid"
                :icon="
        ...
        <img src="/wedding/intro.jpeg" class="first-image" draggable="false" />
        <section class="section-1">
            <p class="text-2xl mb-5">김부민 · 박리평</p>

            <p class="mb-2">2025년 4월 20일(일요일) 낮 12시 30분</p>
            ...
            <h3 class="text-2xl font-bold">결혼합니다❤️</h3>
        </section>
        ...
        <div
            class="w-full max-w-96 mx-auto text-center flex gap-16 flex-col fade-in"
        >
            <img
            ...
            <img src="/wedding/deco.svg" class="w-full" draggable="false" />
        </div>
        ...
        <MarriageGallary class="fade-in" :pictures="weddingPictures" />
        ...
        <div class="w-full max-w-96 mx-auto text-center my-5 fade-in">
            <h1 class="text-2xl mb-3">2025.04.20</h1>
            <p class="mb-5">일요일 낮 12시 30분</p>
            <img
            ...
            <!-- 남은시간 -->
            <MarriageDDay date="2025-04-20T12:30:00" />
        </div>
        ...
        <div class="w-full max-w-96 mx-auto text-center my-5 fade-in">
            <p class="mb-1">벨라루체웨딩홀 서울점 7층 플로체홀</p>
            <p class="mb-3">서울 동대문구 망우로 61</p>
            <p class="">TEL. 02-2242-6312</p>
        </div>
        <div
        ...
        <section
            class="w-full max-w-96 mx-auto mb-5 flex flex-col gap-5 px-5 fade-in"
        >
            <UFormGroup
                label="지하철 이용시"
            ...
            <UFormGroup label="버스 이용시" description="삼육서울병원 하차 ">
                <ul class="list-disc px-5 text-sm">
                    <li>
                        간선버스<br />
                        105, 201, 202, 241, 260, 270, 271, 272
                    </li>
                    <li>
                        지선버스<br />
                        1213, 1224, 1227, 2115, 2211
                    </li>
                    <li>
                        일반버스<br />
                        30, 51, 65, 88, 165, 166, 166-1, 170, 202, 707
                    </li>
                    <li>
                        직행버스<br />
                        1330-2, 1330-3, 1330-4, 1330-44, 3200, 8005
                    </li>
                    <li>
                        좌석버스<br />
                        330-1
            ...
            <UFormGroup label="자가용 이용시">
                <ul class="list-disc px-5 text-sm">
                    <li>
                        네비게이션 : "벨라루체 서울" 또는 "벨라루체웨딩홀
                        서울점" 입력
                    </li>
                    <li>
                        주소 검색 : "서울 망우로 61" 또는 "서울 휘경동 267-9"
                        검색
                    </li>
                    <li>
